...
from .contracts import (
    RunMode, RunStage, ConnectionSummary, SearchProfile,
    HeroMetrics, PersonaViewModel, ExperimentRecord,
    CompressionSummary, LlmConfig, EvalCase
)
...
class RunContext:
    def __init__(
        ...
        self.current_profile: SearchProfile = connection.baseline_profile.model_copy(deep=True)
        self.best_profile: SearchProfile = connection.baseline_profile.model_copy(deep=True)
        self.baseline_profile: SearchProfile = connection.baseline_profile.model_copy(deep=True)
